...
public class CompanyFileVO {
	private int cp_idx;
	private String cf_store_image;
	private String cf_alias_store_image;
	...
	public String getCf_store_image() {
		return cf_store_image;
	}
	public void setCf_store_image(String cf_store_image) {
		this.cf_store_image = cf_store_image;
	}
	public String getCf_alias_store_image() {
		return cf_alias_store_image;
	}
	public void setCf_alias_store_image(String cf_alias_store_image) {
		this.cf_alias_store_image = cf_alias_store_image;
	}
	...
	public String getCf_ect_files() {
		return cf_ect_files;
	}
	public void setCf_ect_files(String cf_ect_files) {
		this.cf_ect_files = cf_ect_files;
	}
