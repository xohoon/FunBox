...
<body>
  <div id="wrap">
    ...
    <input type="hidden" name="find_pw_key" id="find_pw_key" >
    <h3>비밀번호찾기</h3>
     <div id="intro">
        <p class="tt1">
            안녕하세요.<br>
      ...
      <div id="id-group" class="group cf">
        ...
        <input type="button" class="letter" value="인증번호받기" onclick="send_pw_sms();">
        </div><!--#ph-->
        <div id="verti-group" class="group cf">
        <input type="button" class="num_ch" value="확인" onClick="find_pw_confirm();">
        <input type="text" id="verti_num" name="verti_num" placeholder="인증번호 6자리">
        </div><!--#verti-->
        <input type="button" class="submit" value="제출하기" onClick="find_pw_confirm();">
        <div class="found_id">
