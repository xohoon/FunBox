 		...
 		<div class="asset">
			...
			<div class="b1">
				<div>
					...
					<button class="copybtn" data-clipboard-target="#bar" data-clipboard-action="copy">복사하기</button>
					</div>
       </div>                
			</div>
			<div>
				<div class="b2 cf">
					...
					<div>
						<label>입금받을 수량</label>
						<input type="text" class="coin" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/><span>Coin</span>
						<div class="coinbtn">
				...
				<div class="b3 cf">
					...
					<input type="button" value="출금하기" class="send_btn">
				</div><!--출금하기-->
              <div id="send"></div>
			</div><!--2-->
			<div class="b4 c">
