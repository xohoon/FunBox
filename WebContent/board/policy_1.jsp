  ...
  <div id="wrap">
      ...
      <section id="container">
     	 <div class="cover">
      		<div class="tit">
				<h3>서비스이용약관 </h3>
				<h5>펀박스 서비스이용과 관련하여 필요한 사항을 규정합니다.</h5>
			</div>
	 	</div>
		  ...
		  <div class="inwrap cf">
			...
			<div>
				<a href="./data/funbox_policy_service.pdf" download><i class="fas fa-download"></i> 서비스이용약관 다운로드</a>
				<article>
					<h4>제 1장 총칙</h4>
					<h5>제 1조 (목적)</h5>
					<ol>
						<li>
							본 약관은 아이오랩이 운영하는 웹 사이트 (http://xxx.xxx.xxx)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
						</li>
					</ol>
					<h5>제 2조 (용어의 정의)</h5>
					...
					<ol>
						...
						<li>
							핀코드(Pin code) : 회원의 식별확인을 할 수 있는 6자리 숫자로 구성된 개인식별번호
						</li>
						<li>
				...
				<ol>
					...
					<li>
						사이트를 통해 실행되는 모든 펀딩은 투자유본 약관 및 차후 회사사정에 따라 변경된 약관은 이용자에게 공시함으로써 효력을 발생한다.
					</li>
				</ol>
				<h5>제 4 조 (약관 외 준칙)</h5>
				<p>
				...
				<h5>제 15조 (서비스 이용 책임)</h5>
				<p>
					이용자는 회사에서 권한 있는 사원이 서명한 명시적인 서면에 구체적으로 허용한 경우를 제외하고는 서비스를 이용하여 불법상품을 판매하는 영업활동을 할 수 없으며 특히 해킹, 돈벌기 광고, 음란 사이트를 통한 상업행위, 상용 S/W 불법제공 등을 할 수 없다.<br>
					이를 어기고 발생한 영업활동의 결과 및 손실, 관계기관에 의한 구속 등 법적 조치 등에 관해서는 회사가 책임을 지지 않는다.
				</p>
				<h4>제 5장 펀딩</h4>
				<h5>제 16 조 (펀딩 방법)</h5>
				<p>
					‘회원’은 본 사이트에 게시 되어있는 투자 상품에 관하여 ‘펀박스 포인트’를 지불하여 펀딩에 참가 할 수 있다. 이때 ‘펀박스 포인트’는 펀박스 토큰을 환전하여 얻을 수 있다.<br>
					‘펀박스 포인트’ 또한 일정수량 이상의 기준을 충족 하였을때 펀박스 토큰으로 환전 가능하며, 이 과정에서 ‘회사’는 소정의 수수료를 징수한다.
				</p>
				<ol>
					<li>
						본 사이트에서 보유하고 있는 펀박스 토큰을 외부 지갑으로 이동하고자하는 ‘회원’은 사이트의 출금 서비스를 통하여 이동이 가능하다.
					</li>
					<li>
						외부 거래소에서 확보한 펀박스 토큰을 본 사이트로 이동하고자하는 ‘회원’은 사이트의 입금 서비스를 통하여 이동이 가능하다.
					</li>
				</ol>
				<h5>제 17 조 (펀딩 취소 및 철회 규정)</h5>
				<p>
					‘회사’는 ‘회원’의 펀딩 신청이 있는 경우 펀딩 관련 내용은 해당게시판에서 확인 할 수 있다.<br>
					펀딩 관련 내용을 확인한 이용자는 의사표시의 불일치 등이 있는 경우에는 확인 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 ‘회사’는 펀딩 완료 전 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리한다.<br>
					다만 이미 펀딩 완료가 된 경우에는 펀딩 철회를 할 수 없다.
				</p>
				<h4>제 6장 기타</h4>
				<h5>제 19 조 (면책 및 손해배상)</h5>
				<ol>
					<li>
					...
					<li>
						이용자가 본 약관의 규정을 위반함으로써 회사에 손해가 발생하는 경우 이 약관을 위반한 이용자는 회사에 발생한 모든 손해를 배상해야 하며 동 손해로 부터 회사를 면책 시켜야 한다.
					</li>
				</ol>
				<h5>제 20 조 (개인신용정보 제공 및 활용에 대한 동의서)</h5>
				<p>
					회사가 회원 가입과 관련해 취득한 개인 신용 정보는 신용정보의 이용 및 보호에 관한 법률 제23조의 규정에 따라 타인에게 제공 및 활용 시 이용자의 동의를 얻어야 한다.<br>
					이용자의 동의는 회사가 회원으로 가입한 이용자의 신용정보를 신용정보기관, 신용정보업자 및 기타 이용자 등에게 제공해 이용자의 신용을 판단하기 위한 자료로서 활용하거나 공공기관에서 정책 자료로 활용하는데 동의하는 것으로 간주한다.
				</p>
				<h5>제 21 조 (분쟁의 해결)</h5>
				<ol>
					<li>
